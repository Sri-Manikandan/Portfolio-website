        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2 lg:pl-20">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    <motion.a variants={container(1.2)} initial="hidden" animate="visible" whileHover={{scale:1.1}} whileTap={{scale:0.9}} className='border-2 bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-2xl tracking-tight text-transparent rounded-full px-8 py-4 my-4 mt-3' href='https://drive.google.com/file/d/1xhzkSzkEqS416xSmh0Z-z2DK-ZzOqIh2/view?usp=drive_link'>Resume</motion.a>
                </div>
            </div>
